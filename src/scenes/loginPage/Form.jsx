...
const initialValuesRegister = {
    firstName: "", lastName: "", email: "", password: "", location: "", occupation: "", picture: "",
};
...
const Form = () => {
    ...
    const login = async (values, onSubmitProps) => {
        ...
        if (loggedIn) {
            dispatch(setLogin({
                user: loggedIn.user, token: loggedIn.token,
            }));
            navigate("/home")
        }
    };
        ...
        {({
            ...
            <Box>
                ...
                <Typography
                    ...
                    sx={{
                        textDecoration: "underline", color: palette.primary.main, "&:hover": {
